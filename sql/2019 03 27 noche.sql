...
insert  into `corridas`(`id`,`cliente_id`,`desembolso_id`,`fecha_pago`,`np`,`pago_completo`,`capital`,`interes`,`seguro`,`pago_capital`,`pago_interes`,`pago_seguro`,`saldo`) values (1,5,1,'2019-03-23',1,'535.00','322.00','193.00','20.00','322.00','193.00','20.00','0.00'),(2,5,1,'2019-03-30',2,'535.00','322.00','193.00','20.00','322.00','193.00','20.00','0.00'),(3,5,1,'2019-04-06',3,'535.00','322.00','193.00','20.00','322.00','193.00','20.00','0.00'),(4,5,1,'2019-04-13',4,'535.00','322.00','193.00','20.00','322.00','193.00','20.00','0.00'),(5,5,1,'2019-04-20',5,'535.00','322.00','193.00','20.00','322.00','193.00','20.00','0.00'),(6,5,1,'2019-04-27',6,'535.00','322.00','193.00','20.00','322.00','193.00','20.00','0.00'),(7,5,1,'2019-05-04',7,'535.00','322.00','193.00','20.00','322.00','193.00','20.00','0.00'),(8,5,1,'2019-05-11',8,'535.00','322.00','193.00','20.00','322.00','193.00','20.00','0.00'),(9,5,1,'2019-05-18',9,'535.00','322.00','193.00','20.00','322.00','193.00','20.00','0.00'),(10,5,1,'2019-05-25',10,'535.00','322.00','193.00','20.00','322.00','193.00','20.00','0.00'),(11,5,1,'2019-06-01',11,'535.00','322.00','193.00','20.00','322.00','193.00','20.00','0.00'),(12,5,1,'2019-06-08',12,'535.00','322.00','193.00','20.00','322.00','193.00','20.00','0.00'),(13,5,1,'2019-06-15',13,'535.00','322.00','193.00','20.00','322.00','193.00','20.00','0.00'),(14,5,1,'2019-06-22',14,'535.00','322.00','193.00','20.00','322.00','193.00','20.00','0.00'),(15,4,4,'2019-04-15',1,'840.00','500.00','300.00','40.00','500.00','300.00','40.00','0.00'),(16,4,4,'2019-04-30',2,'840.00','500.00','300.00','40.00','500.00','300.00','40.00','0.00'),(17,4,4,'2019-05-15',3,'840.00','500.00','300.00','40.00','500.00','300.00','40.00','0.00'),(18,4,4,'2019-05-31',4,'840.00','500.00','300.00','40.00','0.00','0.00','0.00','840.00'),(19,4,4,'2019-06-15',5,'840.00','500.00','300.00','40.00','0.00','0.00','0.00','840.00'),(20,4,4,'2019-06-30',6,'840.00','500.00','300.00','40.00','0.00','0.00','0.00','840.00'),(21,4,4,'2019-07-15',7,'840.00','500.00','300.00','40.00','0.00','0.00','0.00','840.00'),(22,4,4,'2019-07-31',8,'840.00','500.00','300.00','40.00','0.00','0.00','0.00','840.00');
...
insert  into `corridas_tipo_c`(`id`,`cliente_id`,`desembolso_id`,`fecha_pago`,`pago_completo`,`capital`,`interes`,`pago_capital`,`pago_interes`,`estatus_id`,`saldo`) values (6,8,3,'2019-03-31','7700.00','7000.00','700.00','7000.00','700.00',2,'0.00');
...
insert  into `desembolsos`(`id`,`fecha`,`primer_pago`,`capital`,`pago_completo`,`pago_capital`,`pago_interes`,`pago_seguro`,`estatus_id`,`tipo_id`,`cliente_id`,`capturista_id`,`fecha_registro`,`hora_registro`) values (3,'2019-03-20','2019-03-31','7000.00','7700.00','7000.00','700.00','0.00',2,3,8,1,'2019-03-20','20:09:41'),(4,'2019-03-27','2019-04-15','4000.00','840.00','500.00','300.00','40.00',5,2,4,1,'2019-03-27','01:06:43');
...
insert  into `pagos`(`id`,`fecha`,`np`,`pago_completo`,`pago_capital`,`pago_interes`,`pago_seguro`,`cliente_id`,`desembolso_id`,`tipo_pago`,`capturista_id`,`fecha_registro`,`hora_registro`) values (1,'2019-03-27',1,'840.00','500.00','300.00','40.00',4,4,'N',1,'2019-03-27','01:11:03'),(2,'2019-03-27',2,'840.00','500.00','300.00','40.00',4,4,'N',1,'2019-03-27','01:18:17'),(3,'2019-03-27',3,'840.00','500.00','300.00','40.00',4,4,'N',1,'2019-03-27','01:18:49');
...
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_estadodecuentacliente` AS (select `d`.`id` AS `id`,`d`.`cliente_id` AS `cliente_id`,`d`.`capital` AS `capital`,`d`.`pago_completo` AS `pago_completo`,(case when (`d`.`tipo_id` < 3) then ifnull((select sum(`corridas`.`saldo`) from `corridas` where ((`corridas`.`desembolso_id` = `d`.`id`) and (`corridas`.`fecha_pago` < curdate()))),0) when (`d`.`tipo_id` = 3) then ifnull((select sum(`corridas_tipo_c`.`saldo`) from `corridas_tipo_c` where ((`corridas_tipo_c`.`desembolso_id` = `d`.`id`) and (`corridas_tipo_c`.`fecha_pago` <= curdate()) and (`corridas_tipo_c`.`estatus_id` = 5))),0) end) AS `saldoVencido`,(case when (`d`.`tipo_id` < 3) then ifnull((select sum(`corridas`.`saldo`) from `corridas` where ((`corridas`.`desembolso_id` = `d`.`id`) and (`corridas`.`fecha_pago` <= curdate()))),0) when (`d`.`tipo_id` = 3) then ifnull((select sum(`corridas_tipo_c`.`saldo`) from `corridas_tipo_c` where ((`corridas_tipo_c`.`desembolso_id` = `d`.`id`) and (`corridas_tipo_c`.`fecha_pago` <= curdate()) and (`corridas_tipo_c`.`estatus_id` = 5))),0) end) AS `pagoExigible`,(case when (`d`.`tipo_id` < 3) then ifnull((select sum(`corridas`.`saldo`) from `corridas` where ((`corridas`.`desembolso_id` = `d`.`id`) and (`corridas`.`fecha_pago` <> 0))),0) when (`d`.`tipo_id` = 3) then ifnull((select sum(`corridas_tipo_c`.`saldo`) from `corridas_tipo_c` where ((`corridas_tipo_c`.`desembolso_id` = `d`.`id`) and (`corridas_tipo_c`.`estatus_id` = 5))),0) end) AS `saldoTotal`,`d`.`tipo_id` AS `tipo_id` from `desembolsos` `d` where (`d`.`estatus_id` = 5)) */;
