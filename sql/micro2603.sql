...
insert  into `desembolsos`(`id`,`fecha`,`primer_pago`,`capital`,`pago_completo`,`pago_capital`,`pago_interes`,`pago_seguro`,`estatus_id`,`tipo_id`,`cliente_id`,`capturista_id`,`fecha_registro`,`hora_registro`) values (1,'2019-03-20','2019-03-23','4500.00','535.00','322.00','193.00','20.00',5,1,5,1,'2019-03-20','20:14:48'),(3,'2019-03-20','2019-03-31','7000.00','7700.00','7000.00','700.00','0.00',2,3,8,1,'2019-03-20','20:09:41');
...
CREATE TABLE `pagos` (
  ...
  `pago_completo` decimal(10,2) DEFAULT '0.00',
  `pago_capital` decimal(10,2) DEFAULT '0.00',
  `pago_interes` decimal(10,2) DEFAULT '0.00',
  `pago_seguro` decimal(10,2) DEFAULT '0.00',
  `cliente_id` int(11) DEFAULT NULL,
  `desembolso_id` int(11) DEFAULT NULL,
  `tipo_pago` enum('N','P','A') COLLATE utf8_unicode_ci DEFAULT 'N',
  `capturista_id` int(11) DEFAULT NULL,
  `fecha_registro` date DEFAULT NULL,
  `hora_registro` time DEFAULT NULL,
  PRIMARY KEY (`id`)
...
insert  into `pagos`(`id`,`fecha`,`pago_completo`,`pago_capital`,`pago_interes`,`pago_seguro`,`cliente_id`,`desembolso_id`,`tipo_pago`,`capturista_id`,`fecha_registro`,`hora_registro`) values (1,'2019-03-25','7700.00','7000.00','700.00','0.00',8,3,'P',1,'2019-03-25','00:04:28');
