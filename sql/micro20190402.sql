...
CREATE TABLE `caja` (
  ...
  `tipo` enum('E','S') COLLATE utf8_unicode_ci NOT NULL,
  `capturista_id` int(11) NOT NULL,
  `transferencia_id` int(11) NOT NULL,
  `tipo_caja` int(11) NOT NULL,
...
insert  into `caja`(`id`,`descripcion`,`fecha`,`importe`,`caja_id`,`tipo`,`capturista_id`,`transferencia_id`,`tipo_caja`,`fecha_captura`,`hora_captura`) values (1,'NOMINA SEGUNDA QUINCENA DE MARZO','2019-03-31','30000.00',1,'E',1,0,2,'2019-04-02','20:11:01'),(2,'NOMINA SEGUNDA QUINCENA DE MARZO','2019-03-31','12000.00',2,'S',1,0,2,'2019-04-02','20:13:28'),(3,'NOMINA SEGUNDA QUINCENA DE MARZO','2019-03-31','16000.00',2,'S',1,0,2,'2019-04-02','20:13:46'),(4,'DSDSSDDSASDASDA','2019-04-02','6000.00',1,'S',1,0,2,'2019-04-02','20:24:34');
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AVG_ROW_LENGTH=1820;

/*Data for the table `carteras` */

insert  into `carteras`(`id`,`descripcion`) values (7,'CARTERA BEATRIZ A'),(8,'CARTERA BEATRIZ B'),(3,'CARTERA DOMINGO A'),(4,'CARTERA DOMINGO B'),(5,'CARTERA DOMINGO C'),(6,'CARTERA DOMINGO D'),(1,'CARTERA MARYSOL A'),(2,'CARTERA MARYSOL B');
...
CREATE TABLE `clientes` (
  ...
  `fecha_nacimiento` date NOT NULL DEFAULT '1992-06-26',
  `sexo` enum('H','M') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'H',
  `IFE` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `cp` varchar(6) COLLATE utf8_unicode_ci NOT NULL DEFAULT '80000',
  `colonia` varchar(50) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'CENTRO',
  `calle` varchar(50) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'CULIACAN',
  `domicilio_ref` varchar(150) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'CULIACAN',
  `cartera_id` int(11) NOT NULL DEFAULT '1',
  `telefono` varchar(20) COLLATE utf8_unicode_ci NOT NULL DEFAULT '00000000',
  `capturista_id` int(11) NOT NULL DEFAULT '1',
  `fecha_registro` date NOT NULL,
  `hora_registro` time NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=64 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AVG_ROW_LENGTH=3276;

/*Data for the table `clientes` */

insert  into `clientes`(`id`,`appaterno`,`apmaterno`,`nombre`,`fecha_nacimiento`,`sexo`,`IFE`,`cp`,`colonia`,`calle`,`domicilio_ref`,`cartera_id`,`telefono`,`capturista_id`,`fecha_registro`,`hora_registro`) values (1,'   ','  ','CARLOS SAMIR PARTIDA ALMANZA','1992-06-26','H','X1','80000','CENTRO','CULIACAN','CULIACAN',1,'00000000',1,'2019-03-29','17:14:25'),(2,'','','KARLA JANETH SICAIROS CALVO','1992-06-26','H','X2','80000','CENTRO','CULIACAN','CULIACAN',1,'00000000',1,'2019-03-29','17:14:25'),(3,'','','CARMEN CAMACHO SALAS','1992-06-26','H','X3','80000','CENTRO','CULIACAN','CULIACAN',1,'00000000',1,'2019-03-29','17:14:25'),(4,'','','EVELYN PATIÑO (REYES)','1992-06-26','H','X4','80000','CENTRO','CULIACAN','CULIACAN',1,'00000000',1,'2019-03-29','17:14:25'),(5,'','','FLOR ITZEL','1992-06-26','H','X5','80000','CENTRO','CULIACAN','CULIACAN',1,'00000000',1,'2019-03-29','17:14:25'),(6,'','','CLARA YIRET CEBREROS','1992-06-26','H','X6','80000','CENTRO','CULIACAN','CULIACAN',1,'00000000',1,'2019-03-29','17:14:25'),(7,'','','CARMEN ALICIA CAMACHO RAMOS','1992-06-26','H','X7','80000','CENTRO','CULIACAN','CULIACAN',1,'00000000',1,'2019-03-29','17:14:25'),(8,'','','BAUDELIO ARELLANO PASOS','1992-06-26','H','X8','80000','CENTRO','CULIACAN','CULIACAN',1,'00000000',1,'2019-03-29','17:14:25'),(9,'','','LUIS ALBERTO RODRIGUEZ SERRANO','1992-06-26','H','X9','80000','CENTRO','CULIACAN','CULIACAN',1,'00000000',1,'2019-03-29','17:14:25'),(10,'','','ROSALBA LOPEZ','1992-06-26','H','X10','80000','CENTRO','CULIACAN','CULIACAN',1,'00000000',1,'2019-03-29','17:14:25'),(11,'','','CLAUDIA MARISOL ALMANZA','1992-06-26','H','X11','80000','CENTRO','CULIACAN','CULIACAN',1,'00000000',1,'2019-03-29','17:14:25'),(12,'','','KATIA LOPEZ ','1992-06-26','H','X12','80000','CENTRO','CULIACAN','CULIACAN',1,'00000000',1,'2019-03-29','17:14:25'),(13,'','','MIRANDA SAINZ MARIELENA','1992-06-26','H','X13','80000','CENTRO','CULIACAN','CULIACAN',1,'00000000',1,'2019-03-29','17:14:25'),(14,'','','MENDOZA SANDOVAL SAUL','1992-06-26','H','X14','80000','CENTRO','CULIACAN','CULIACAN',1,'00000000',1,'2019-03-29','17:14:25'),(15,'','','HERRERA CHAIDEZ AMADO','1992-06-26','H','X15','80000','CENTRO','CULIACAN','CULIACAN',1,'00000000',1,'2019-03-29','17:14:25'),(16,'','','JUAN ANTONIO VELAZQUEZ','1992-06-26','H','X16','80000','CENTRO','CULIACAN','CULIACAN',1,'00000000',1,'2019-03-29','17:14:25'),(17,'','','LUIS ENRIQUE MURILLO PEREZ','1992-06-26','H','X17','80000','CENTRO','CULIACAN','CULIACAN',1,'00000000',1,'2019-03-29','17:14:25'),(18,'','','JAZMIN SIERRA TORRES','1992-06-26','H','X18','80000','CENTRO','CULIACAN','CULIACAN',1,'00000000',1,'2019-03-29','17:14:25'),(19,'','','ILDA GABRIELA TORRES DIAZ','1992-06-26','H','X19','80000','CENTRO','CULIACAN','CULIACAN',1,'00000000',1,'2019-03-29','17:14:25'),(20,'','','ELIDORA VALENTINA PARDO ZAMORA','1992-06-26','H','X20','80000','CENTRO','CULIACAN','CULIACAN',1,'00000000',1,'2019-03-29','17:14:25'),(21,'','','VEGA ZAMORA MIRIAM','1992-06-26','H','X21','80000','CENTRO','CULIACAN','CULIACAN',1,'00000000',1,'2019-03-29','17:14:25'),(22,'','','LOPEZ BARAJAS ERICK','1992-06-26','H','X22','80000','CENTRO','CULIACAN','CULIACAN',1,'00000000',1,'2019-03-29','17:14:25'),(23,'','','SERGIO YAHIR FLORES','1992-06-26','H','X23','80000','CENTRO','CULIACAN','CULIACAN',1,'00000000',1,'2019-03-29','17:14:25'),(24,'','','MIGUEL ANGEL URREA CAMACHO','1992-06-26','H','X24','80000','CENTRO','CULIACAN','CULIACAN',1,'00000000',1,'2019-03-29','17:14:25'),(25,'','','DOLORES SANDUÑO MARISCAL','1992-06-26','H','X25','80000','CENTRO','CULIACAN','CULIACAN',1,'00000000',1,'2019-03-29','17:14:25'),(26,'','','JAZMIN SIERRA TORRES','1992-06-26','H','X26','80000','CENTRO','CULIACAN','CULIACAN',1,'00000000',1,'2019-03-29','17:14:25'),(27,'','','ARACELI LOPEZ GALVEZ','1992-06-26','H','X27','80000','CENTRO','CULIACAN','CULIACAN',1,'00000000',1,'2019-03-29','17:14:25'),(28,'','','KINGZU LOAIZA MORENO','1992-06-26','H','X28','80000','CENTRO','CULIACAN','CULIACAN',1,'00000000',1,'2019-03-29','17:14:25'),(29,'','','MAYRA MARTINEZ MENDOZA','1992-06-26','H','X29','80000','CENTRO','CULIACAN','CULIACAN',1,'00000000',1,'2019-03-29','17:14:25'),(30,'','','CAMERINA VEGA SOTO','1992-06-26','H','X30','80000','CENTRO','CULIACAN','CULIACAN',1,'00000000',1,'2019-03-29','17:14:25'),(31,'','','FLOR AGUILAR ','1992-06-26','H','X31','80000','CENTRO','CULIACAN','CULIACAN',1,'00000000',1,'2019-03-29','17:14:25'),(32,'','','MARIELENA DUARTE','1992-06-26','H','X32','80000','CENTRO','CULIACAN','CULIACAN',1,'00000000',1,'2019-03-29','17:14:25'),(33,'','','EVELYN PATIÑO REYES','1992-06-26','H','X33','80000','CENTRO','CULIACAN','CULIACAN',1,'00000000',1,'2019-03-29','17:14:25'),(34,'','','BENITO PEÑA JIMENEZ','1992-06-26','H','X34','80000','CENTRO','CULIACAN','CULIACAN',1,'00000000',1,'2019-03-29','17:14:25'),(35,'','','JESUS SALOMON','1992-06-26','H','X35','80000','CENTRO','CULIACAN','CULIACAN',1,'00000000',1,'2019-03-29','17:14:25'),(36,'','','MIGUEL ANGEL URREA URIAS','1992-06-26','H','X36','80000','CENTRO','CULIACAN','CULIACAN',1,'00000000',1,'2019-03-29','17:14:25'),(37,'','','TREJO SOTO RAMON','1992-06-26','H','X37','80000','CENTRO','CULIACAN','CULIACAN',1,'00000000',1,'2019-03-29','17:14:25'),(38,'','','JOSE ANGEL BELTRAN CORRALES','1992-06-26','H','X38','80000','CENTRO','CULIACAN','CULIACAN',1,'00000000',1,'2019-03-29','17:14:25'),(39,'','','AYON ANGULO MARTINA ISADRA','1992-06-26','H','X39','80000','CENTRO','CULIACAN','CULIACAN',1,'00000000',1,'2019-03-29','17:14:25'),(40,'','','MARIA ISABEL ALFONSO','1992-06-26','H','X40','80000','CENTRO','CULIACAN','CULIACAN',1,'00000000',1,'2019-03-29','17:14:25'),(41,'','','CAMERINA VEGA SOTO','1992-06-26','H','X41','80000','CENTRO','CULIACAN','CULIACAN',1,'00000000',1,'2019-03-29','17:14:25'),(42,'','','ARACELI LOPEZ GALVEZ','1992-06-26','H','X42','80000','CENTRO','CULIACAN','CULIACAN',1,'00000000',1,'2019-03-29','17:14:25'),(43,'','','KARLA JANETH SICAIROS CALVO','1992-06-26','H','X43','80000','CENTRO','CULIACAN','CULIACAN',1,'00000000',1,'2019-03-29','17:14:25'),(44,'','','MARIBEL CUEN','1992-06-26','H','X44','80000','CENTRO','CULIACAN','CULIACAN',1,'00000000',1,'2019-03-29','17:14:25'),(45,'','','TREJO SOTO RAMON','1992-06-26','H','X45','80000','CENTRO','CULIACAN','CULIACAN',1,'00000000',1,'2019-03-29','17:14:25'),(46,'','','LOAIZA BERMUDEZ ALMA ROSA','1992-06-26','H','X46','80000','CENTRO','CULIACAN','CULIACAN',1,'00000000',1,'2019-03-29','17:14:25'),(47,'','','GASTELUM CORRALES ANGELICA','1992-06-26','H','X47','80000','CENTRO','CULIACAN','CULIACAN',1,'00000000',1,'2019-03-29','17:14:25'),(48,'','','MARIA DOLORES MORALES LIZARRAGA','1992-06-26','H','X48','80000','CENTRO','CULIACAN','CULIACAN',1,'00000000',1,'2019-03-29','17:14:25'),(49,'','','TORRES SAENZ CLAUDIA LIZETTE','1992-06-26','H','X49','80000','CENTRO','CULIACAN','CULIACAN',1,'00000000',1,'2019-03-29','17:14:25'),(50,'','','MUROS HERRERA GLORIA GUADALUPE','1992-06-26','H','X50','80000','CENTRO','CULIACAN','CULIACAN',1,'00000000',1,'2019-03-29','17:14:25'),(51,'','','CATALINA LOPEZ GALVEZ','1992-06-26','H','X51','80000','CENTRO','CULIACAN','CULIACAN',1,'00000000',1,'2019-03-29','17:14:25'),(52,'','','JORGE CARLOS DIAZ ALFARO','1992-06-26','H','X52','80000','CENTRO','CULIACAN','CULIACAN',1,'00000000',1,'2019-03-29','17:14:25'),(53,'','','PRESTO MAMA','1992-06-26','H','X53','80000','CENTRO','CULIACAN','CULIACAN',1,'00000000',1,'2019-03-29','17:14:25'),(54,'','','BENITO PEÑA JIMENEZ','1992-06-26','H','X54','80000','CENTRO','CULIACAN','CULIACAN',1,'00000000',1,'2019-03-29','17:14:25');
...
CREATE TABLE `corridas_tipo_c` (
  ...
  `pago_capital` decimal(10,2) NOT NULL DEFAULT '0.00',
  `pago_interes` decimal(10,2) NOT NULL DEFAULT '0.00',
  `estatus_id` int(2) NOT NULL DEFAULT '5',
  `saldo` decimal(10,2) NOT NULL DEFAULT '0.00',
  PRIMARY KEY (`id`)
...
insert  into `corridas_tipo_c`(`id`,`cliente_id`,`desembolso_id`,`fecha_pago`,`pago_completo`,`capital`,`interes`,`pago_capital`,`pago_interes`,`estatus_id`,`saldo`) values (1,1,1,'2019-03-31','1100.00','1000.00','100.00','0.00','0.00',5,'1100.00'),(2,2,2,'2019-03-31','2200.00','2000.00','200.00','0.00','0.00',5,'2200.00'),(3,3,3,'2019-03-31','3300.00','3000.00','300.00','0.00','0.00',5,'3300.00'),(4,4,4,'2019-03-31','1100.00','1000.00','100.00','0.00','0.00',5,'1100.00'),(5,5,5,'2019-03-31','3300.00','3000.00','300.00','0.00','0.00',5,'3300.00'),(6,6,6,'2019-03-31','1650.00','1500.00','150.00','0.00','0.00',5,'1650.00'),(7,7,7,'2019-03-31','3300.00','3000.00','300.00','0.00','0.00',5,'3300.00'),(8,8,8,'2019-03-31','5500.00','5000.00','500.00','0.00','0.00',5,'5500.00'),(9,9,9,'2019-03-31','5500.00','5000.00','500.00','0.00','0.00',5,'5500.00'),(10,10,10,'2019-03-31','5500.00','5000.00','500.00','0.00','0.00',5,'5500.00'),(11,11,11,'2019-03-31','1650.00','1500.00','150.00','0.00','0.00',5,'1650.00'),(12,12,12,'2019-03-31','1100.00','1000.00','100.00','0.00','0.00',5,'1100.00'),(13,13,13,'2019-03-31','5500.00','5000.00','500.00','0.00','0.00',5,'5500.00'),(14,14,14,'2019-03-31','3300.00','3000.00','300.00','0.00','0.00',5,'3300.00'),(15,15,15,'2019-03-31','5500.00','5000.00','500.00','0.00','0.00',5,'5500.00'),(16,16,16,'2019-03-31','3300.00','3000.00','300.00','0.00','0.00',5,'3300.00'),(17,17,17,'2019-03-31','1100.00','1000.00','100.00','0.00','0.00',5,'1100.00'),(18,18,18,'2019-03-31','1100.00','1000.00','100.00','0.00','0.00',5,'1100.00'),(19,19,19,'2019-03-31','3300.00','3000.00','300.00','0.00','0.00',5,'3300.00'),(20,20,20,'2019-03-31','1100.00','1000.00','100.00','0.00','0.00',5,'1100.00'),(21,21,21,'2019-03-31','2200.00','2000.00','200.00','0.00','0.00',5,'2200.00'),(22,22,22,'2019-03-31','3300.00','3000.00','300.00','0.00','0.00',5,'3300.00'),(23,23,23,'2019-03-31','2200.00','2000.00','200.00','0.00','0.00',5,'2200.00'),(24,24,24,'2019-03-31','3300.00','3000.00','300.00','0.00','0.00',5,'3300.00'),(25,25,25,'2019-03-31','3300.00','3000.00','300.00','0.00','0.00',5,'3300.00'),(26,26,26,'2019-03-31','1650.00','1500.00','150.00','0.00','0.00',5,'1650.00'),(27,27,27,'2019-03-31','2200.00','2000.00','200.00','0.00','0.00',5,'2200.00'),(28,28,28,'2019-03-31','3300.00','3000.00','300.00','0.00','0.00',5,'3300.00'),(29,29,29,'2019-03-31','2200.00','2000.00','200.00','0.00','0.00',5,'2200.00'),(30,30,30,'2019-03-31','1650.00','1500.00','150.00','0.00','0.00',5,'1650.00'),(31,31,31,'2019-03-31','1100.00','1000.00','100.00','0.00','0.00',5,'1100.00'),(32,32,32,'2019-03-31','3850.00','3500.00','350.00','0.00','0.00',5,'3850.00'),(33,33,33,'2019-03-31','2200.00','2000.00','200.00','0.00','0.00',5,'2200.00'),(34,34,34,'2019-03-31','2200.00','2000.00','200.00','0.00','0.00',5,'2200.00'),(35,35,35,'2019-03-31','16500.00','15000.00','1500.00','0.00','0.00',5,'16500.00'),(36,36,36,'2019-03-31','3300.00','3000.00','300.00','0.00','0.00',5,'3300.00'),(37,37,37,'2019-03-31','1650.00','1500.00','150.00','0.00','0.00',5,'1650.00'),(38,38,38,'2019-03-31','3850.00','3500.00','350.00','0.00','0.00',5,'3850.00'),(39,39,39,'2019-03-31','2200.00','2000.00','200.00','0.00','0.00',5,'2200.00'),(40,40,40,'2019-03-31','5500.00','5000.00','500.00','0.00','0.00',5,'5500.00'),(41,41,41,'2019-03-31','1100.00','1000.00','100.00','0.00','0.00',5,'1100.00'),(42,42,42,'2019-03-31','1100.00','1000.00','100.00','0.00','0.00',5,'1100.00'),(43,43,43,'2019-03-31','550.00','500.00','50.00','0.00','0.00',5,'550.00'),(44,44,44,'2019-03-31','3080.00','2800.00','280.00','0.00','0.00',5,'3080.00'),(45,45,45,'2019-03-31','1650.00','1500.00','150.00','0.00','0.00',5,'1650.00'),(46,46,46,'2019-03-31','2200.00','2000.00','200.00','0.00','0.00',5,'2200.00'),(47,47,47,'2019-03-31','3300.00','3000.00','300.00','0.00','0.00',5,'3300.00'),(48,48,48,'2019-03-31','3300.00','3000.00','300.00','0.00','0.00',5,'3300.00'),(49,49,49,'2019-03-31','3300.00','3000.00','300.00','0.00','0.00',5,'3300.00'),(50,50,50,'2019-03-31','4400.00','4000.00','400.00','0.00','0.00',5,'4400.00'),(51,51,51,'2019-03-31','4400.00','4000.00','400.00','0.00','0.00',5,'4400.00'),(52,52,52,'2019-03-31','33000.00','30000.00','3000.00','0.00','0.00',5,'33000.00'),(53,53,53,'2019-03-31','1650.00','1500.00','150.00','0.00','0.00',5,'1650.00'),(54,54,54,'2019-03-31','1100.00','1000.00','100.00','1000.00','100.00',2,'0.00');
...
CREATE TABLE `cortes` (
  ...
  `desembolsos` decimal(10,2) NOT NULL,
  `tipo_caja` int(11) NOT NULL,
  `capturista_id` int(11) NOT NULL,
  `fecha_captura` date NOT NULL,
  `hora_captura` time NOT NULL,
...
CREATE TABLE `desembolsos` (
  ...
  `tipo_id` int(2) NOT NULL DEFAULT '3',
...
insert  into `desembolsos`(`id`,`fecha`,`primer_pago`,`capital`,`pago_completo`,`pago_capital`,`pago_interes`,`pago_seguro`,`estatus_id`,`tipo_id`,`cliente_id`,`capturista_id`,`fecha_registro`,`hora_registro`) values (1,'2019-03-29','2019-03-31','1000.00','1100.00','1000.00','100.00','0.00',5,3,1,1,'2019-03-29','17:44:10'),(2,'2019-03-29','2019-03-31','2000.00','2200.00','2000.00','200.00','0.00',5,3,2,1,'2019-03-29','17:44:10'),(3,'2019-03-29','2019-03-31','3000.00','3300.00','3000.00','300.00','0.00',5,3,3,1,'2019-03-29','17:44:10'),(4,'2019-03-29','2019-03-31','1000.00','1100.00','1000.00','100.00','0.00',5,3,4,1,'2019-03-29','17:44:10'),(5,'2019-03-29','2019-03-31','3000.00','3300.00','3000.00','300.00','0.00',5,3,5,1,'2019-03-29','17:44:10'),(6,'2019-03-29','2019-03-31','1500.00','1650.00','1500.00','150.00','0.00',5,3,6,1,'2019-03-29','17:44:10'),(7,'2019-03-29','2019-03-31','3000.00','3300.00','3000.00','300.00','0.00',5,3,7,1,'2019-03-29','17:44:10'),(8,'2019-03-29','2019-03-31','5000.00','5500.00','5000.00','500.00','0.00',5,3,8,1,'2019-03-29','17:44:10'),(9,'2019-03-29','2019-03-31','5000.00','5500.00','5000.00','500.00','0.00',5,3,9,1,'2019-03-29','17:44:10'),(10,'2019-03-29','2019-03-31','5000.00','5500.00','5000.00','500.00','0.00',5,3,10,1,'2019-03-29','17:44:10'),(11,'2019-03-29','2019-03-31','1500.00','1650.00','1500.00','150.00','0.00',5,3,11,1,'2019-03-29','17:44:10'),(12,'2019-03-29','2019-03-31','1000.00','1100.00','1000.00','100.00','0.00',5,3,12,1,'2019-03-29','17:44:10'),(13,'2019-03-29','2019-03-31','5000.00','5500.00','5000.00','500.00','0.00',5,3,13,1,'2019-03-29','17:44:10'),(14,'2019-03-29','2019-03-31','3000.00','3300.00','3000.00','300.00','0.00',5,3,14,1,'2019-03-29','17:44:10'),(15,'2019-03-29','2019-03-31','5000.00','5500.00','5000.00','500.00','0.00',5,3,15,1,'2019-03-29','17:44:10'),(16,'2019-03-29','2019-03-31','3000.00','3300.00','3000.00','300.00','0.00',5,3,16,1,'2019-03-29','17:44:10'),(17,'2019-03-29','2019-03-31','1000.00','1100.00','1000.00','100.00','0.00',5,3,17,1,'2019-03-29','17:44:10'),(18,'2019-03-29','2019-03-31','1000.00','1100.00','1000.00','100.00','0.00',5,3,18,1,'2019-03-29','17:44:10'),(19,'2019-03-29','2019-03-31','3000.00','3300.00','3000.00','300.00','0.00',5,3,19,1,'2019-03-29','17:44:10'),(20,'2019-03-29','2019-03-31','1000.00','1100.00','1000.00','100.00','0.00',5,3,20,1,'2019-03-29','17:44:10'),(21,'2019-03-29','2019-03-31','2000.00','2200.00','2000.00','200.00','0.00',5,3,21,1,'2019-03-29','17:44:10'),(22,'2019-03-29','2019-03-31','3000.00','3300.00','3000.00','300.00','0.00',5,3,22,1,'2019-03-29','17:44:10'),(23,'2019-03-29','2019-03-31','2000.00','2200.00','2000.00','200.00','0.00',5,3,23,1,'2019-03-29','17:44:10'),(24,'2019-03-29','2019-03-31','3000.00','3300.00','3000.00','300.00','0.00',5,3,24,1,'2019-03-29','17:44:10'),(25,'2019-03-29','2019-03-31','3000.00','3300.00','3000.00','300.00','0.00',5,3,25,1,'2019-03-29','17:44:10'),(26,'2019-03-29','2019-03-31','1500.00','1650.00','1500.00','150.00','0.00',5,3,26,1,'2019-03-29','17:44:10'),(27,'2019-03-29','2019-03-31','2000.00','2200.00','2000.00','200.00','0.00',5,3,27,1,'2019-03-29','17:44:10'),(28,'2019-03-29','2019-03-31','3000.00','3300.00','3000.00','300.00','0.00',5,3,28,1,'2019-03-29','17:44:10'),(29,'2019-03-29','2019-03-31','2000.00','2200.00','2000.00','200.00','0.00',5,3,29,1,'2019-03-29','17:44:10'),(30,'2019-03-29','2019-03-31','1500.00','1650.00','1500.00','150.00','0.00',5,3,30,1,'2019-03-29','17:44:10'),(31,'2019-03-29','2019-03-31','1000.00','1100.00','1000.00','100.00','0.00',5,3,31,1,'2019-03-29','17:44:10'),(32,'2019-03-29','2019-03-31','3500.00','3850.00','3500.00','350.00','0.00',5,3,32,1,'2019-03-29','17:44:10'),(33,'2019-03-29','2019-03-31','2000.00','2200.00','2000.00','200.00','0.00',5,3,33,1,'2019-03-29','17:44:10'),(34,'2019-03-29','2019-03-31','2000.00','2200.00','2000.00','200.00','0.00',5,3,34,1,'2019-03-29','17:44:10'),(35,'2019-03-29','2019-03-31','15000.00','16500.00','15000.00','1500.00','0.00',5,3,35,1,'2019-03-29','17:44:10'),(36,'2019-03-29','2019-03-31','3000.00','3300.00','3000.00','300.00','0.00',5,3,36,1,'2019-03-29','17:44:10'),(37,'2019-03-29','2019-03-31','1500.00','1650.00','1500.00','150.00','0.00',5,3,37,1,'2019-03-29','17:44:10'),(38,'2019-03-29','2019-03-31','3500.00','3850.00','3500.00','350.00','0.00',5,3,38,1,'2019-03-29','17:44:10'),(39,'2019-03-29','2019-03-31','2000.00','2200.00','2000.00','200.00','0.00',5,3,39,1,'2019-03-29','17:44:10'),(40,'2019-03-29','2019-03-31','5000.00','5500.00','5000.00','500.00','0.00',5,3,40,1,'2019-03-29','17:44:10'),(41,'2019-03-29','2019-03-31','1000.00','1100.00','1000.00','100.00','0.00',5,3,41,1,'2019-03-29','17:44:10'),(42,'2019-03-29','2019-03-31','1000.00','1100.00','1000.00','100.00','0.00',5,3,42,1,'2019-03-29','17:44:10'),(43,'2019-03-29','2019-03-31','500.00','550.00','500.00','50.00','0.00',5,3,43,1,'2019-03-29','17:44:10'),(44,'2019-03-29','2019-03-31','2800.00','3080.00','2800.00','280.00','0.00',5,3,44,1,'2019-03-29','17:44:10'),(45,'2019-03-29','2019-03-31','1500.00','1650.00','1500.00','150.00','0.00',5,3,45,1,'2019-03-29','17:44:10'),(46,'2019-03-29','2019-03-31','2000.00','2200.00','2000.00','200.00','0.00',5,3,46,1,'2019-03-29','17:44:10'),(47,'2019-03-29','2019-03-31','3000.00','3300.00','3000.00','300.00','0.00',5,3,47,1,'2019-03-29','17:44:10'),(48,'2019-03-29','2019-03-31','3000.00','3300.00','3000.00','300.00','0.00',5,3,48,1,'2019-03-29','17:44:10'),(49,'2019-03-29','2019-03-31','3000.00','3300.00','3000.00','300.00','0.00',5,3,49,1,'2019-03-29','17:44:10'),(50,'2019-03-29','2019-03-31','4000.00','4400.00','4000.00','400.00','0.00',5,3,50,1,'2019-03-29','17:44:10'),(51,'2019-03-29','2019-03-31','4000.00','4400.00','4000.00','400.00','0.00',5,3,51,1,'2019-03-29','17:44:10'),(52,'2019-03-29','2019-03-31','30000.00','33000.00','30000.00','3000.00','0.00',5,3,52,1,'2019-03-29','17:44:10'),(53,'2019-03-29','2019-03-31','1500.00','1650.00','1500.00','150.00','0.00',5,3,53,1,'2019-03-29','17:44:10'),(54,'2019-03-29','2019-03-31','1000.00','1100.00','1000.00','100.00','0.00',2,3,54,1,'2019-03-29','17:44:10');
...
CREATE TABLE `detalles_usuario_cartera` (
  ...
  `cartera_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AVG_ROW_LENGTH=3276;
...
insert  into `importes`(`id`,`importe`,`interes`,`semanas`,`quincenas`,`pago_completo`,`pago_capital`,`pago_interes`,`seguro`,`total`,`totalSeguro`,`tipo_id`) values (1,'2500.00','1500.00',14,0,'306.00','179.00','107.00','20.00','4000.00','4280.00',1),(2,'3000.00','1800.00',14,0,'363.00','215.00','128.00','20.00','4800.00','5080.00',1),(3,'3500.00','2100.00',14,0,'420.00','250.00','150.00','20.00','5600.00','5880.00',1),(4,'4000.00','2400.00',14,0,'478.00','286.00','172.00','20.00','6400.00','6680.00',1),(5,'4500.00','2700.00',14,0,'535.00','322.00','193.00','20.00','7200.00','7480.00',1),(6,'5000.00','3000.00',14,0,'592.00','358.00','214.00','20.00','8000.00','8280.00',1),(7,'2500.00','1500.00',0,8,'540.00','313.00','187.00','40.00','4000.00','4320.00',2),(8,'3000.00','1800.00',0,8,'640.00','375.00','225.00','40.00','4800.00','5120.00',2),(9,'3500.00','2100.00',0,8,'740.00','438.00','262.00','40.00','5600.00','5920.00',2),(10,'4000.00','2400.00',0,8,'840.00','500.00','300.00','40.00','6400.00','6720.00',2),(11,'4500.00','2700.00',0,8,'940.00','563.00','337.00','40.00','7200.00','7520.00',2),(12,'5000.00','3000.00',0,8,'1040.00','625.00','375.00','40.00','8000.00','8320.00',2);
...
CREATE TABLE `pagos` (
  ...
  `cliente_id` int(11) NOT NULL,
  `desembolso_id` int(11) NOT NULL,
  `tipo_pago` enum('N','P','A') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'N',
  `capturista_id` int(11) NOT NULL,
  `fecha_registro` date NOT NULL,
  `hora_registro` time NOT NULL,
  PRIMARY KEY (`id`)
...
insert  into `pagos`(`id`,`fecha`,`np`,`pago_completo`,`pago_capital`,`pago_interes`,`pago_seguro`,`cliente_id`,`desembolso_id`,`tipo_pago`,`capturista_id`,`fecha_registro`,`hora_registro`) values (1,'2019-03-29',0,'1.00','0.00','1.00','0.00',54,54,'A',1,'2019-03-29','20:32:29'),(2,'2019-03-29',0,'1.00','0.00','1.00','0.00',54,54,'A',1,'2019-03-29','20:32:33'),(3,'2019-03-29',0,'1.00','0.00','1.00','0.00',54,54,'A',1,'2019-03-29','20:35:21'),(4,'2019-03-29',0,'1097.00','1000.00','97.00','0.00',54,54,'P',1,'2019-03-29','20:52:55');
...
insert  into `tipo_caja`(`id`,`descripcion`) values (1,'CARTERA'),(2,'OFICINA');
...
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AVG_ROW_LENGTH=1638;

/*Data for the table `usuarios` */

insert  into `usuarios`(`id`,`appaterno`,`apmaterno`,`nombre`,`usuario`,`password`,`estatus_id`,`autorizacion`,`admin`,`autorizacion_esp`,`rol_id`) values (1,'CORTEZ','CORTEZ','AXEL ENRIQUE','AXEL','05b8caaf6ba6f4bdb68675ab8b893bda',5,'S','S','S',1),(12,'PONCE','PONCE','SERGIO','SERGIO','f516dfb84b9051ed85b89cdc3a8ab7f5',5,'N','N','N',1);
...
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_estadodecuentacliente` AS (select `d`.`id` AS `id`,`d`.`cliente_id` AS `cliente_id`,`d`.`capital` AS `capital`,`d`.`pago_completo` AS `pago_completo`,(case when (`d`.`tipo_id` < 3) then ifnull((select sum(`corridas`.`saldo`) AS `sum(``corridas``.``saldo``)` from `corridas` where ((`corridas`.`desembolso_id` = `d`.`id`) and (`corridas`.`fecha_pago` < curdate()))),0) when (`d`.`tipo_id` = 3) then ifnull((select sum(`corridas_tipo_c`.`saldo`) AS `sum(``corridas_tipo_c``.``saldo``)` from `corridas_tipo_c` where ((`corridas_tipo_c`.`desembolso_id` = `d`.`id`) and (`corridas_tipo_c`.`fecha_pago` <= curdate()) and (`corridas_tipo_c`.`estatus_id` = 5))),0) end) AS `saldoVencido`,(case when (`d`.`tipo_id` < 3) then ifnull((select sum(`corridas`.`saldo`) AS `sum(``corridas``.``saldo``)` from `corridas` where ((`corridas`.`desembolso_id` = `d`.`id`) and (`corridas`.`fecha_pago` <= curdate()))),0) when (`d`.`tipo_id` = 3) then ifnull((select sum(`corridas_tipo_c`.`saldo`) AS `sum(``corridas_tipo_c``.``saldo``)` from `corridas_tipo_c` where ((`corridas_tipo_c`.`desembolso_id` = `d`.`id`) and (`corridas_tipo_c`.`fecha_pago` <= curdate()) and (`corridas_tipo_c`.`estatus_id` = 5))),0) end) AS `pagoExigible`,(case when (`d`.`tipo_id` < 3) then ifnull((select sum(`corridas`.`saldo`) AS `sum(``corridas``.``saldo``)` from `corridas` where ((`corridas`.`desembolso_id` = `d`.`id`) and (`corridas`.`fecha_pago` <> 0))),0) when (`d`.`tipo_id` = 3) then ifnull((select sum(`corridas_tipo_c`.`saldo`) AS `sum(``corridas_tipo_c``.``saldo``)` from `corridas_tipo_c` where ((`corridas_tipo_c`.`desembolso_id` = `d`.`id`) and (`corridas_tipo_c`.`estatus_id` = 5))),0) end) AS `saldoTotal`,`d`.`tipo_id` AS `tipo_id` from `desembolsos` `d` where (`d`.`estatus_id` = 5)) */;
