...
insert  into `corridas_tipo_c`(`id`,`cliente_id`,`desembolso_id`,`fecha_pago`,`pago_completo`,`capital`,`interes`) values (1,0,2,'0000-00-00','5500.00','5000.00','500.00'),(2,0,3,'2019-03-31','5500.00','5000.00','500.00'),(3,0,4,'2019-03-31','660.00','600.00','60.00'),(4,0,5,'2019-03-31','7700.00','7000.00','700.00'),(5,0,5,'2019-03-31','5500.00','5000.00','500.00'),(6,8,3,'2019-03-31','7700.00','7000.00','700.00');
...
insert  into `desembolsos`(`id`,`fecha`,`primer_pago`,`capital`,`pago_completo`,`pago_capital`,`pago_interes`,`pago_seguro`,`estatus_id`,`tipo_id`,`cliente_id`,`capturista_id`,`fecha_registro`,`hora_registro`) values (1,'2019-03-20','2019-03-23','4500.00','535.00','322.00','193.00','20.00',5,1,5,1,'2019-03-20','20:14:48'),(2,'2019-03-20','2019-03-31','3000.00','40.00','0.00','0.00','40.00',5,2,4,1,'2019-03-20','20:14:56'),(3,'2019-03-20','2019-03-31','7000.00','7700.00','7000.00','0.00','0.00',5,3,8,1,'2019-03-20','20:09:41');
...
CREATE TABLE `pagos` (
  ...
  `tipo_pago` enum('E','N') COLLATE utf8_unicode_ci DEFAULT 'N',
  `fecha_registro` date DEFAULT NULL,
  `hora_registro` time DEFAULT NULL,
  `usuario_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
