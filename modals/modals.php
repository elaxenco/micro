...
<div class="modal fade" id="modalDesembolso" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                ...
                <div class="container">
                    <div class="row">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control col-12 mr-3" aria-label="Username"
                                aria-describedby="basic-addon1" readonly id="c_id_desembolso">
                        </div>
                    </div>
                    <div class="row">
...
<!-- MODAL DE HISTORIAL -->
<div class="modal fade" id="modalHistial" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <div class="container">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-7">
                            <button type="button" class="btn btn-primary mt-1 mb-1">Pagos <i
                                    class="fas fa-dollar-sign"></i></button>
                            <button type="button" class="btn btn-primary mt-1 mb-1">Desembolsos <i
                                    class="fas fa-money-bill-alt"></i></button>
                            <button type="button" onclick="buscarPagosDesembolsoActual()"
                                class="btn btn-primary mt-1 mb-1">Desembolso Act. <i
                                    class="fas fa-money-bill-alt"></i></button>
                        </div>
...
<div class="modal fade" id="modalAgregarCapital" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Saldo actual clientes</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
                ...
                <div class="container">
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6 col-12 mt-1">
                            ...
                            <input class="form-control" id="saldoActual" readonly>
                        </div>
                        <div class="col-md-6 col-12 mt-1">
                    ...
                    <div class="col-12  mt-3 ">
                        ...
                        <button type="button" class="btn btn-success col-12 col-lg-2   float-right mr-2 mt-2 mb-2"
                            onclick="renovarCliente()">Guardar</button> 
                    </div>
                </div>
            </div>
            <div class="modal-footer">
